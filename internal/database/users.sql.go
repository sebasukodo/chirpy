...
const updateUserVIP = `-- name: UpdateUserVIP :one
UPDATE users
...
func (q *Queries) UpdateUserVIP(ctx context.Context, id uuid.UUID) (User, error) {
	row := q.db.QueryRowContext(ctx, updateUserVIP, id)
	var i User
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
